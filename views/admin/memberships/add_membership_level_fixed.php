<h3 class="hndle"><label for="title"><?php Quickr_I18n::e ('Add/Edit Membership Level That Expires on a Fixed Date')?></label></h3>    
<p><?php Quickr_I18n::e('Create a new membership level that expires on a predefined date')?>.</p>
<form method="post" name="create-membership-level" id="quickr-membership-level" class="validate" novalidate="novalidate">
    ...
    <input type="hidden" name="duration_type" value="fixed" />
        ...
        <tbody>
            <tr class="form-field form-required<?php echo isset($this->membership_data->errors['name'])? " form-invalid" : "";?>" >
                ...
                <td><p><?php Quickr_I18n::e('Give a title for this membership level')?></p>
                    <input name="name" id="name" aria-required="true" value="<?php echo $membership->name; ?>" autocapitalize="none" autocorrect="off" maxlength="60" type="text"><br/>                                    
                </td>
            </tr>
            <tr class="form-field form-required<?php echo isset($this->membership_data->errors['role'])? " form-invalid" : "";?>">
                ...
                <td><p><?php Quickr_I18n::e('Default role given to members assigned to this membership level')?></p>
            ...
            <tr class="form-field form-required<?php echo isset($this->membership_data->errors['duration'])? " form-invalid" : "";?>">
                ...
                <td>                    <p><?php Quickr_I18n::e('Specify the date after which access privilege to this membership level will expire')?></p>
            ...
            <tr class="form-field">
                ...
                <td><p><?php Quickr_I18n::e('Default home page for this membership level. Members assigned to this membership level will be redirected to this page after login. Can be left empty')?>.</p>
            ...
            <tr class="form-field">
                ...
                <td>
                    <input name="campaign_name" id="campaign_name" value="<?php echo $membership->campaign_name;?>" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="60" type="text">
                </td>
            </tr>                        
        </tbody>
    </table>
