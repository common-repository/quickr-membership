=== QuickR Membership ===
Contributors: amijanina
Donate link: https://quickr-member.blogspot.com/
...
Quickr membership plugin is a tightly integrated membership plugin that adds membership capability to your wordpress side.

== Description ==

= An easy-to-use membership plugin that enables you to create site offering free and paid content =

The simple membership plugin lets you protect your posts and pages so only your members can view the protected content.

= Fluid Integration with Core Wordpress System =
Quickr Membership nicely integrates with core Wordpress system. It doesn't have to maintain separate user database. Therefore, no chance of
user data getting out of sync. Since it heavily relies on core wordpress, it is able to take full advantage of new release of Wordpress.
...
Read the [setup documentation](https://quickr-member.blogspot.com/2016/07/quickr-membership-documentation.html) after you install the plugin to get started.

= Plugin Support =

If you have any issue with this plugin, please  send us a contact: quickr.membership@gmail.com
...
You can translate the plugin using the language [translation documentation](http://quickr-member.blogspot.com/2016/07/quickr-translation-documentation.html).

== Installation ==

Do the following to install the membership plugin:

1. Upload the 'quickr-membership.zip' file from the Plugins->Add New page in the WordPress administration panel.
...
Please visit the screenshot page to view screenshots:
http://quickr-member.blogspot.com/2016/07/quickr-screenshots.html
...
= 1.0.1 =
- Added dashoard page for the plugin
